import { CoreWordPress } from "../src/core/Wordpress";
...
(async ()=> {
    ...
    // controller.resolve_intitle()
    // controller.resolve_limit()

    // console.log(controller.get())

    // console.log(await controller.isGetContentElPais("https://brasil.elpais.com/economia/2021-12-12/elon-musk-busca-fincar-satelites-nos-ceus-brasileiros-um-mercado-ainda-pouco-regulado.html"))
    // console.log(await controller.isGetContentG1("https://g1.globo.com/pr/parana/noticia/2021/09/25/homem-e-morto-e-dois-ficam-feridos-apos-confronto-em-curitiba-diz-pm.ghtml"))
